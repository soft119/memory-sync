...
lines.append(b'SENDMSG 6 ==========DEBUG PATH1==========')
lines.append(b'SENDMSG 6 HUMAN: <$HUMAN(\xb5\xe3\xbf\xa8\xca\xb1\xbc\xe4)>')
lines.append(b'MOV N0 <$HUMAN(\xb5\xe3\xbf\xa8\xca\xb1\xbc\xe4)>')
lines.append(b'SENDMSG 6 N0: <$STR(N0)>')
lines.append(b'SENDMSG 6 ==============================')
lines.append(b'#SAY')
lines.append(b'\xc7\xeb\xb2\xe9\xbf\xb4\xc1\xc4\xcc\xec\xbf\xf2!\\')
...
print('NPC脚本已更新（尝试路径格式: \\系统功能\\点卡时间.txt）')
